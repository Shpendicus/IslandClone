namespace RemObjects.Elements.System;
  ...
  type
    ...
    public
      ...
      method CompareTo(const a: Char): boolean;
      begin
        result := self - a;
      end;
	  ...
	  {$Region Aritmethical Operators}
	  method &Add(const a: INumber): INumber; implement INumber.&Add
	  begin
		var word1 := Int16(self);
		var word2 := Int16(a);		
		exit INumber(word1 + word2);
	  end;
	  
	  method &Subtract(const a: INumber): INumber; implement INumber.&Subtract
	  begin
		var word1 := Int16(self);
		var word2 := Int16(a);		
		exit INumber(word1 - word2);
	  ...
	  method &Multiply(const a: INumber): INumber; implement INumber.&Multiply
	  begin
		var word1 := Int16(self);
		var word2 := Int16(a);		
		exit INumber(word1 * word2);
	  ...
	  method &Divide(const a: INumber): INumber; implement INumber.&Divide
	  require
	    Int16(a) <> 0;		
	  begin
		var word1 := Int16(self);
		var word2 := Int16(a);		
		exit INumber(word1 div word2);
	  end;
	  {$ENDREGION}
